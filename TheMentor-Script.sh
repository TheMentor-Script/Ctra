...
echo $b"============================================="
echo   "Team    : TheMentor $white" |lolcat
echo   "Creadby  : TheMentor $white" |lolcat
echo   "Contact  : 08571******* $white" |lolcat
echo   "YouTube : Still in Progres $white" |lolcat
echo $b"============================================="
...
case $pil in
1) clear
toilet -f standard " TheMentor " -F gay
...
00) echo "created by : TheMentor" | lolcat
exit
;;
